  ...
  async init() {
    ...
    this.server.tool(
      ...
      async (params) => {
        try {
          ...
          await session.setContext(params);
          ...
          return {
            content: [{
              ...
              text: JSON.stringify({
                error: error.message,
                suggestion: error.suggestion || "Check error and try again",
    ...
    this.server.tool(
      ...
      async ({ instance_name, database_id }) => {
        ...
        const enrichedParams = await this.enrichToolParams({ instance_name, database_id });
    ...
    this.server.tool(
      ...
      async ({ instance_name, workspace_id, table_id, page, per_page }) => {
        // Enrich parameters with session defaults
        const enrichedParams = await this.enrichToolParams({ instance_name, workspace_id, table_id, page, per_page });
        const { instance_name = enrichedParams.instance_name, workspace_id = enrichedParams.workspace_id, ...otherParams } = enrichedParams;
    ...
    this.server.tool(
      ...
      async ({ instance_name, workspace_id, table_id, record_id, record_data }) => {
        // Enrich parameters with session defaults
        const enrichedParams = await this.enrichToolParams({ instance_name, workspace_id, table_id, record_id, record_data });
        const { instance_name = enrichedParams.instance_name, workspace_id = enrichedParams.workspace_id, ...otherParams } = enrichedParams;
    ...
    // ===========================
        ...
        this.server.tool(
          ...
          async ({ instance_name, workspace_id, page = 1, per_page = 50 }) => {
        // Enrich parameters with session defaults
        const enrichedParams = await this.enrichToolParams({ instance_name, workspace_id, page = 1, per_page = 50 });
        const { instance_name = enrichedParams.instance_name, workspace_id = enrichedParams.workspace_id, ...otherParams } = enrichedParams;
        ...
        // Enrich parameters with session defaults
        const enrichedParams = await this.enrichToolParams({instance_name, workspace_id, api_group_id, page = 1, per_page = 50});
        const { instance_name = enrichedParams.instance_name, workspace_id = enrichedParams.workspace_id, ...otherParams } = enrichedParams;
