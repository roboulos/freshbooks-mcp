      ...
      async ({ instance_name, workspace_id, table_id, name, description, docs, auth, tag }) => {
        ...
        try {
          ...
          return {
            content: [{
              type: "text",
              text: JSON.stringify(result || { success: true, message: "✏️ TABLE UPDATED: " + "Table updated successfully" })
            }]
          };
        } catch (error) {
        ...
        try {
          ...
          return {
            content: [{
              ...
              text: JSON.stringify({
                success: true,
                message: "🗑️ TABLE DELETED: " + "Table deleted successfully",
                operation: "xano_delete_table"
              })
            }]
          };
          ...
          async ({instance_name, workspace_id, include_data = false}) => {
            ...
            try {
              ...
              return {
                content: [{ type: "text", text: JSON.stringify({
                  success: true,
                  message: "📤 EXPORT COMPLETE: " + "Workspace export completed successfully",
                  data: result,
          ...
          async ({instance_name, workspace_id, branch, password}) => {
            ...
            try {
              ...
              return {
                content: [{ type: "text", text: JSON.stringify({
                  success: true,
                  message: "📤 SCHEMA EXPORTED: " + "Schema export completed successfully",
                  data: result,
